                                            ...
                                            <div class="info">
                                                <div class="product-name">
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <div>Item Unit: <span class="value">${item.getItemUnit()}</span>
                                                        </div>
                                                        <div>Quantity: <span class="value">${items.get(item)}</span>
                                                        </div>
                                                        <div style="color: #D0110F;">Price: <span class="value">Rs.
                                        ...
                                        <div class="col-md-2 text-left">
                                            <form method="post">
                                                ...
                                                <button type="submit" rel="tooltip"
                                                    class="btn btn-close btn-just-icon btn-sm" data-original-title=""
                                                    title="" formaction="remove">
