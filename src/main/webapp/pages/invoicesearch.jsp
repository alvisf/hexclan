				...
				<div class="login-form">
					...
					<form method="post">
						<div class="flex">
							...
							<div class="form-group">
								<button class="btn btn-block my-2 my-sm-0 m-2 main-button" type="submit" formaction="/manage/getinvoice">Search by
									Invoice</button>
							</div>
							<div class="form-group">
								<button class="btn  main-button" type="submit" formaction="">Search by
									Customer</button>
							</div>
															...
															<tbody>
																<c:forEach items="${itemtrancs}" var="itemtranc">
																	<tr>
																		...
																		<td class="text-right">
																			<span>${itemtranc.getItemQuantity()}</span></td>
																		<td class="text-right">
