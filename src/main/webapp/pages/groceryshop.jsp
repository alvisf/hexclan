...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="shopping1">Grocery Shop <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
	...
	<div>
		<h1 class="text-center mt-4">
			<span class="accent-color">GROCERY</span> SHOP
		</h1>
	</div>
	<p class="lead text-center mt-2 accent-color">
		Where quality is no compromise.
	</p>
	<p class="text-center caption">Select products to add to your cart.</p>
	<div class="item-list">
		<div class="container">
			<spring:form commandName="items" action="submitShoppingForm1" method="post">
				<div class="row items">
					<c:forEach items="${items}" var="item">
						<div class="col-sm-6 col-md-4 item text-center">
							...
							<div class="col-sm mt-2 mb-4 m-auto">
								<button type="submit"
									class="btn btn-block my-2 my-sm-0 btn-main text-uppercase m-auto">
									Add to Cart
								</button>
							</div>
						</div>
