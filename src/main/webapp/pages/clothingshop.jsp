		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="shopping2">Apparel Shop <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					...
					<c:forEach items="${items}" var="item">
						<div class="col-sm-6 col-md-4 item text-center">
							...
							<div class="col-sm mt-2 mb-4 m-auto">
								<button type="submit" class="btn btn-block my-2 my-sm-0 m-auto btn-main text-uppercase">
									Add to Cart</button>
							</div>
						</div>
					</c:forEach>
