	...
	<div class="edit-form">
		<spring:form modelAttribute="item" method="post" action="submitadd">
			<div class="col-sm text-center mt-4">
				<h1><span class="accent-color">Add</span> Product</h1>
			</div>
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-6 col-md-10 ml-auto mr-auto">
					<img src="https://image.freepik.com/free-vector/add-notes-concept-illustration_114360-2496.jpg" alt=""
						width="100%">
				</div>
				<div class="col-lg-6 col-md-10 ml-auto mr-auto">
					<div class="add-form mb-4">
						...
						<div class="form-label-group mb-2">
							<button type="submit" class="btn btn-lg btn-block btn-main">ADD PRODUCT</button>
						</div>
					</div>
				</div>
			</div>
