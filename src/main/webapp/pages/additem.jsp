...
<body>
	...
	<div class="edit-form">
		...
		<h3 class="text-center">ADD ITEM</h3>
			...
			<div class="form-group">
				<spring:input path="imgurl" type="text" class="form-control item"
					placeholder="Image URL" required="required" />
			</div>
			<div class="form-group">
				<spring:select path="itemCategory" class="form-control item">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-block my-2 my-sm-0 main-button">Add</button>
			</div>
		</spring:form>
	</div>
