	...
	<%@ taglib uri="http://www.springframework.org/tags/form" prefix="spring" %>
		<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			...
			<body>
				<nav class="navbar navbar-dark bg-dark navbar-expand-lg justify-content-between">
					...
					<div class="container-fluid collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link" href="\/manage/submitallForm">Inventory</a></li>
							<li class="nav-item"><a class="nav-link" href="/manage/home">Invoices</a></li>
						</ul>
				...
				<div class="login-form">
					...
					<form method="post" action="getcustomer">
						<div class="flex">
							...
							<div class="form-group">
								<button class="btn btn-block my-2 my-sm-0 m-2 main-button" type="submit">Search by
									Customer</button>
							</div>
				...
				<div class="container">
					<form action="loadClothingForm" method="post">
						<div class="row h-100 justify-content-center align-items-center">
							<div class="col-lg-12 col-md-12 ml-auto mr-auto">
								<p class="text-center">customer id:${custid}</p>
								<div class="table-responsive">
									<table class="table table-shopping">
										...
										<tbody>
											<c:forEach items="${itemtrancs}" var="invoice">
												<tr>
													<td class="text-right"><span>${invoice.getTransactionID()}</span></td>
													<td class="text-right"><span>${invoice.getInvoiceMasterDTO().getInvNo()}</span></td>
													<td class="text-right"><span>${invoice.getInvoiceMasterDTO().getInvDate()}</span></td>
																	...
																	<tr>
																		<td>
																			<div class="img-container">
																				<img src=<c:out
																					value='${invoice.getItemDetailsDTO().getImgurl()}' />
																				alt="...">
																			</div>
																		</td>
																		<td class="text-right">
																			<span>${invoice.getItemDetailsDTO().getItemDesc()}</span></td>
																		<td class="text-right">
																			<span>${invoice.getItemDetailsDTO().getItemCategory()}</span></td>
																		<td class="text-right">
																			<span>${invoice.getItemQuantity()}</span></td>
																		<td class="text-right">
																			<span>${invoice.getItemDetailsDTO().getItemPrice()}</span></td>
																	</tr>
