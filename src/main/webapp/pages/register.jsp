							...
							<div class="container">
								<div class="row">
									<div class="col-md-9 col-lg-8 mx-auto">
										<h3 class="main-heading mb-2">Create an Account!</h3>
										<spring:form modelAttribute="user" method="post" action="submitForm">
											...
											<div class="form-label-group mb-2">
												<label class="small" for="userEmail">Email Address</label>
												<spring:input path="userEmail" type="text" class="form-control"
													placeholder="Email ID" required="required" />
											</div>
											<div class="form-label-group mb-2">
												<label class="small" for="userPhone">Phone Number</label>
												<spring:input path="userPhone" type="text" class="form-control"
													placeholder="Phone Number" required="required" />
											</div>
											<div class="form-label-group mb-2">
												<label class="small" for="address">Address</label>
												<spring:input path="userAddress" type="text" class="form-control"
											...
											<div class="text-center">
												<span class="caption">Already have an account?
													<a href="tologin" style="text-decoration: none;">
														Login.</a>
												</span>
											</div>
										</spring:form>
