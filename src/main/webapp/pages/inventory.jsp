			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-10 col-md-10 ml-auto mr-auto">
					<div class="table-responsive">
						<spring:form modelAttribute="itemdet" method="post" action="/manage/submititemForm">
							<div class="flex inline-block">
								<div>
									<input name="id" type="text" style="width: fit-content; margin: 0; float: right;"
										class="form-control" placeholder="Item ID" required="required" />
						...
						<table class="table table-shopping">
							...
							<tbody>
								<c:forEach items="${items}" var="item">
									<tr>
										<td class="text-left"><span>${item.getItemNo()}</span>
										</td>
										<td>
