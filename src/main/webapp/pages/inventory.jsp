				...
				<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
					...
					<body>
						...
						<div class="login-form">
							...
							<form modelAttribute="itemdet" method="post" action="/manage/submititemForm">
								<div class="flex">

									<div class="form-group">
										<input name="id" type="text" class="form-control item"
											placeholder="Item ID" required="required" />
									</div>

									<div class="form-group">
										<button class="btn btn-block my-2 my-sm-0 m-2 main-button" type="submit">Search
											by Item</button>
									</div>
							...
							<form method="post" action="submitallForm">
								<div style="margin: auto">
									<button type="submit" class="btn btn-block my-2 my-sm-0 main-button">View
										All Items</button>
								</div>
							</form>
						...
						<div class="container">
							<spring:form commandName="items" action="loadClothingForm" method="post">
												...
												<tbody>
													<c:forEach items="${items}" var="item">
														<tr>
															...
															<td class="text-right"><span>${item.getItemDesc()}</span>
															</td>
															<td class="text-right"><span>${item.getItemCategory()}</span>
															</td>
															<td class="text-right">
																<span>${item.getStockQuantity()}</span></td>
															<td class="text-right"><span>${item.getItemPrice()}</span>
															</td>
														</tr>
													</c:forEach>
												</tbody>
